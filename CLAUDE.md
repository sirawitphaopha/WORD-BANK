...
- 🚨🚨 **push เสร็จ = เขียน `docs/SESSION-YYYY-MM-DD.md` แล้ว push ตามขึ้นไปด้วยทันที** (ไม่ต้องถาม)
  ...
  - 🔑 **repo นี้เป็นสาธารณะ — ก่อน commit ต้องเอาข้อมูลอ่อนไหวออกก่อนเสมอ**: อีเมล · กุญแจ/โทเคนทุกชนิด (`sb_secret_`, `eyJ`, `sk-`, `re_`) · รหัสผ่าน · ข้อมูลส่วนตัวที่ไม่เกี่ยวกับโค้ด
  - เรียกผู้ใช้ว่า "ผู้ใช้" ในไฟล์ docs (ไม่ใช้ชื่อเล่น) · บันทึกฉบับเต็มยังเก็บในโฟลเดอร์ความจำเหมือนเดิม

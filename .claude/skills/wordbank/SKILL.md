...
- 🚨 **push เสร็จ = เขียน `docs/SESSION-YYYY-MM-DD.md` แล้ว push ตามทันที** (หลายรอบต่อวันเติม b/c/d) · เขียนละเอียดแบบ commit (ต้นเหตุบั๊ก+วิธีแก้+วิธีพิสูจน์+บทเรียน+งานค้าง) · **repo สาธารณะ → เอาอีเมล/กุญแจ/ข้อมูลส่วนตัวออกก่อนเสมอ** เรียกผู้ใช้ว่า "ผู้ใช้"

...
> สำเนานี้อยู่ใน repo เผื่อทำงานบนคลาว (cloud agent) · ต้นฉบับกลางอยู่ที่ `~/.claude/skills/working-with-gun/SKILL.md` — แก้ที่ต้นฉบับแล้ว sync มาที่นี่
...
- ❌🔴 **commit สั้น/ไม่ละเอียด + ไม่อัปเดต README/CLAUDE.md ทุก push** (2026-07-17 พี่กันตำหนิ) → commit ต้อง file-by-file + อัปเดตเอกสารทุก push

...
5d. "meaning" — a SHORT Thai gloss of what the item means, max 60 Thai characters. This is a word bank the novelist browses later; a gloss lets them pick the right word without looking it up.
   • THE TEST IS NOT "COMMON vs RARE" — IT IS "ONE READING vs MANY READINGS".
     A word every Thai knows can still need a gloss if people know it in different senses.
     - One reading only → "meaning": null. It explains itself. (คำราม · หนวดเครา · กระโจน)
     - MORE THAN ONE READING → a gloss is MANDATORY, never null, no matter how ordinary the word looks.
       เสียว is known by every Thai speaker, yet it carries at least four separate readings
       (fear · physical tingle · sexual thrill · vertiginous excitement) — it MUST get a gloss.
       Same for ปราด (darting body · darting glance).
   • Also write one for anything a normal Thai reader would not grasp instantly: literary or archaic
     words (ชะเง้อ · ทุรนทุราย · สิ้นลม), idioms (จนแล้วจนรอด), and rare compounds.
   ...
   • Never pad a single-reading word just to look thorough.
...
5ง. "meaning" — ความหมายสั้น ๆ ภาษาไทย ไม่เกิน 60 ตัวอักษร
   ...
   • ตัวตัดสินไม่ใช่ "คำคุ้นหรือไม่คุ้น" แต่คือ "ตีความได้ทางเดียว หรือได้หลายทาง"
     คำที่คนไทยทุกคนรู้จัก ก็ยังต้องมีความหมายกำกับ ถ้าแต่ละคนรู้จักมันคนละความหมาย
     - ตีความได้ทางเดียว → ใส่ null เพราะอ่านแล้วเข้าใจได้เอง (คำราม · หนวดเครา · กระโจน)
     - ตีความได้มากกว่าหนึ่งทาง → ต้องเขียนเสมอ ห้ามใส่ null ต่อให้เป็นคำธรรมดาแค่ไหนก็ตาม
       เสียว เป็นคำที่คนไทยทุกคนรู้จัก แต่ใช้ได้อย่างน้อย 4 ทาง (กลัว · แปลบทางกาย · เชิงกามารมณ์ · หวาดเสียวตื่นเต้น) จึงต้องมีความหมาย
       เช่นเดียวกับ ปราด (พุ่งตัวไปเร็ว · สายตากวาดไปเร็ว)
   • เขียนให้คำที่คนไทยทั่วไปอ่านแล้วอาจไม่เข้าใจทันทีด้วย เช่น คำวรรณกรรม/คำโบราณ (ชะเง้อ · ทุรนทุราย · สิ้นลม) สำนวน (จนแล้วจนรอด) และคำประสมที่พบไม่บ่อย
   ...
   • คำที่ตีความทางเดียวอยู่แล้ว ไม่ต้องเขียนให้ดูเยอะ

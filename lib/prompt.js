...
5d. "meaning" — a SHORT Thai gloss of what the item means, max 60 Thai characters. This is a word bank the novelist browses later; a gloss lets them pick the right word without looking it up.
   • WRITE A GLOSS FOR EVERY SINGLE ITEM. "meaning" IS NEVER null. Not for common words, not for
   ...
   • FIRST list every reading the item can carry, THEN write the gloss from that list.
     - ONE reading  → the gloss is that reading, stated plainly. (คำราม → "เสียงต่ำกระหึ่มที่เปล่งออกมาอย่างขู่")
     - MANY readings → the gloss MUST cover them all, not just the one this line happens to use.
       เสียว is known by every Thai speaker, yet it carries at least four separate readings
       (fear · physical tingle · sexual thrill · vertiginous excitement) — the gloss must span them.
   ...
   • Keep it tight — a gloss is a definition, not an essay.
...
5ง. "meaning" — ความหมายสั้น ๆ ภาษาไทย ไม่เกิน 60 ตัวอักษร
   ...
   • เขียนความหมายให้ "ทุกก้อน" ห้ามใส่ null เด็ดขาด ไม่ว่าจะเป็นคำธรรมดา คำที่อ่านแล้วเข้าใจเอง หรือประโยคเต็ม
   ...
   • ให้ไล่ก่อนว่าคำนี้ตีความได้กี่ทาง แล้วค่อยเขียนความหมายจากรายการนั้น
     - ตีความได้ทางเดียว → เขียนทางนั้นตรง ๆ (คำราม → "เสียงต่ำกระหึ่มที่เปล่งออกมาอย่างขู่")
     - ตีความได้หลายทาง → ความหมายต้องครอบทุกทาง ไม่ใช่เอาแค่ทางที่บรรทัดนี้ใช้
       เสียว เป็นคำที่คนไทยทุกคนรู้จัก แต่ใช้ได้อย่างน้อย 4 ทาง (กลัว · แปลบทางกาย · เชิงกามารมณ์ · หวาดเสียวตื่นเต้น) ความหมายต้องครอบให้หมด
   ...
   • เขียนให้กระชับ ความหมายคือนิยาม ไม่ใช่เรียงความ

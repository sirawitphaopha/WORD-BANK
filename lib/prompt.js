...
3. ALSO EXTRACT the standout, vivid, worth-keeping words or short phrases that appear INSIDE a long sentence, and output each as an ADDITIONAL separate item — in addition to the full sentence, not replacing it. Example: from "เขาโผงผางบทพูดคำวิปลาสแต่ก็ปราดเปรื่อง" output 4 items: the full sentence PLUS "โผงผาง", "วิปลาส", "ปราดเปรื่อง". Extract only genuinely beautiful/useful words, not dull or common ones.
...
{"items":[{"text":"...","original":null,"kind":"word","category_id":"c2","proposed_category":null,"subcategory":null,"notes":["..."]}],"proposed_categories":[{"name_th":"..."}]}
...
3. นอกจากเก็บประโยคเต็มแล้ว ให้สกัด "คำเด่น" ที่งาม/น่าเก็บ ซึ่งอยู่ในประโยคนั้น ออกมาเป็นก้อนแยกเพิ่มด้วย (เพิ่มเข้ามา ไม่ใช่แทนที่ประโยค) ตัวอย่าง: จาก "เขาโผงผางบทพูดคำวิปลาสแต่ก็ปราดเปรื่อง" ให้ได้ 4 ก้อน คือ ประโยคเต็ม + "โผงผาง" + "วิปลาส" + "ปราดเปรื่อง" สกัดเฉพาะคำที่งามหรือมีประโยชน์จริงๆ ไม่เอาคำธรรมดา

...
export function pill(cat, mono) {
  // padding-right 28px เว้นที่ให้ลูกศร ▾ ของ select ไม่ทับตัวหนังสือ · ชื่อยาวตัด ... (hover เห็นเต็มผ่าน title)
  const b = { padding: '5px 28px 5px 11px', borderRadius: '7px', fontSize: '13px', fontWeight: '600', cursor: 'pointer', outline: 'none', maxWidth: '190px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' };

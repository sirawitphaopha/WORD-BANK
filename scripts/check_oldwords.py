    ...
    for f in outs:
        ...
        for r in rows:
            ...
            for e in (r.get('extract') or []):
                ...
                #    เคยเกือบพลาด 26 ก.ค.: ด่านนี้ฟ้อง `ขี้ริ้วขี้เหร่` กับ `โหนกนูน` ว่าประกอบคำเอง
                #    ทั้งที่พี่กันเขียนโน้ตกำกับไว้เองแล้วว่า "เพิ่มเอง" ใน docs/archive/sessions/SESSION-2026-07-25f.md

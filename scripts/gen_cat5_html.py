...
moved=[('เจียมเนื้อเจียมตัว · สงบเสงี่ยม · บริสุทธิ์ผุดผ่อง','การวางตัว/นิสัยประจำ','๘ บุคลิกภาพ'),
       ...
       ('ใจปลาซิว','🆕 นิสัยขี้กลัว (import เก็บผิดเป็น "ใจปลาซิวขี้กลัว" · จริงเป็นนิสัย · พี่กันชี้)','๘ บุคลิกภาพ'),
       ('น่ารื่นรมย์','🆕 บรรยายบรรยากาศ/มู้ดของสถานที่ (เจนเสนอ)','๑ บรรยากาศ')]
body+='<table class="tb"><tr><th>คำ (๑๖)</th><th>ทำไมยก</th><th>ไปหมวด</th></tr>'

...
> # 🛑 นี่คือผล **1840 จาก 2814 รายการ (65%)** — **ยังไม่ครบ**
>
> ผู้ช่วยถูกตัดกลางคันเพราะชนเพดานการใช้งานของบัญชี 2 รอบ
> **ยังเหลืออีก 974 รายการที่ยังไม่ได้ทบทวน** ตัวเลขทุกตัวในไฟล์นี้จึงยังไม่ใช่ตัวเลขสุดท้าย
>
...
|---|---|
| รายการที่ทบทวน | **1840** |
| เป็นคำที่สกัดมาจากวลี | 662 |
| เป็นวลีตั้งต้น | 1178 |
| ตีความได้หลายทาง | 576 (31%) |
| **กิ่งที่เพิ่ม** | **1684 เส้น** |
| กิ่งที่คงไว้ | 2602 เส้น |
| **กิ่งที่ถอน** | **853 เส้น** |
| กิ่งใหม่ที่เสนอ | 13 กิ่ง |
| ความหมายที่ได้เพิ่ม | 1413 รายการ |
...
|---|---|---|---|---|
| คินดะอิจิยอดนักสืบ ตอน บทเพลงปีศาจ | 1343 | 1623 | 346 | 938 |
| เสียงกระซิบจากความมืด | 435 | 1080 | 519 | 529 |

...
> # 🛑 นี่คือผล **1440 จาก 2814 รายการ (51%)** — **ยังไม่ครบ**
>
> ผู้ช่วยถูกตัดกลางคันเพราะชนเพดานการใช้งานของบัญชี 2 รอบ
> **ยังเหลืออีก 1374 รายการที่ยังไม่ได้ทบทวน** ตัวเลขทุกตัวในไฟล์นี้จึงยังไม่ใช่ตัวเลขสุดท้าย
>
...
|---|---|
| รายการที่ทบทวน | **1440** |
| เป็นคำที่สกัดมาจากวลี | 518 |
| เป็นวลีตั้งต้น | 922 |
| ตีความได้หลายทาง | 524 (36%) |
| **กิ่งที่เพิ่ม** | **1320 เส้น** |
| กิ่งที่คงไว้ | 2078 เส้น |
| **กิ่งที่ถอน** | **646 เส้น** |
| กิ่งใหม่ที่เสนอ | 13 กิ่ง |
| ความหมายที่ได้เพิ่ม | 1095 รายการ |
...
|---|---|---|---|---|
| คินดะอิจิยอดนักสืบ ตอน บทเพลงปีศาจ | 1065 | 1302 | 256 | 729 |
| เสียงกระซิบจากความมืด | 329 | 858 | 398 | 407 |
